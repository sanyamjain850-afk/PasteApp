      ...
      <div className="flex flex-col gap-y-5 items-start">
        ...
        >
          ...
          <textarea
            ...
            className="w-full p-3 text-black focus-visible:ring-0"
            style={{
              caretColor: "#000",
            }}
            rows={20}
...
const Home = () => {
  ...
  const dispatch = useDispatch(); 
  const allPastes = useSelector((state) => state.
  paste.pastes);
  ...
  return ( 
    ...
    <div className='flex flex-row gap-7 place-content-evenly'>
      ...
      <input
      className="p-10 rounded-2xl mt-2
      w-[50%] pl-4 border "
        type= "text"
